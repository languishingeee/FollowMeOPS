...
const app = {
    ...
    ui: {
        ...
        showPerformanceReport: (filter = 'today') => {
            ...
            // Haftalık/Aylık için Firebase arşivinden oku
            if (typeof firebase !== 'undefined' && firebase.database) {
                firebase.database().ref('statsArchive').once('value')
                    .then(snapshot => {
                ...
                content.innerHTML = '<div class="text-center py-8 text-amber-400"><i class="fa-solid fa-cloud-slash text-2xl"></i><p class="mt-2">Firebase bağlantısı yok</p></div>';
            }
        },
        ...
        // İstatistikleri Firebase'e arşivle
        archiveStats: () => {
            ...
            // Firebase'e kaydet
            if (typeof firebase !== 'undefined' && firebase.database) {
                firebase.database().ref('statsArchive/' + today).set(counts)
                    .then(() => {
                ...
                app.ui.toast("Firebase bağlantısı yok", "error");
            }
        },
